...
<p>Below is a sample blog. Users can add comments to the blog. Comments will be added to the page dynamically without page reload due to the use of AJAX. Try writing a comment and adding &lt;script&gt; document.body.style.backgroundColor = "#AA0000"; &lt;/script&gt; somewhere in your comment. After clicking the "Add comment" button, your comment will be shown and any javascript code in it will be executed, because this particular page does not filter out dangerous HTML entities. The script above will change the background color of the page.</p>
